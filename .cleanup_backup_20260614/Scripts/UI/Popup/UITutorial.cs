...
public class UITutorial : UIPopup
{
    ...
    public void OnResetTutorial()
    {
        ...
        GamePlayController.Instance.IsGamePlaying = true;
        ListItemButtons.Instance.OnActiveAllItemButtons(true);
    ...
    {
        var boxAmmoList = GamePlayController.Instance.AmmoBoxObjects;
        boxAmmoList[boxAmmo].GetComponent<BoxAmmo>().OnClickTutorial();
