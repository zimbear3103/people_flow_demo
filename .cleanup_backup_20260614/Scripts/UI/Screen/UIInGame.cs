...
public class UIInGame : UIScreen
{
    ...
    [SerializeField] private Button m_furtherButton;
    [SerializeField] private Button m_sortButton;
    ...
    {
        //m_unlockButton.onClick.AddListener(OnUnlockButtonPressed);
        //m_removeButton.onClick.AddListener(OnRemoveButtonPressed);
        //m_furtherButton.onClick.AddListener(OnFurtherButtonPressed);
        //m_sortButton.onClick.AddListener(OnSortButtonPressed);
    ...
    {
        //m_unlockButton.onClick.RemoveListener(OnUnlockButtonPressed);
        //m_removeButton.onClick.RemoveListener(OnRemoveButtonPressed);
        //m_furtherButton.onClick.RemoveListener(OnFurtherButtonPressed);
        //m_sortButton.onClick.RemoveListener(OnSortButtonPressed);
    ...
    {
        //Set Text Quantity Item Button
        m_sortButton.GetComponentInParent<ItemButton>().OnSetItemCountText(1);
    }

    private void OnFurtherButtonPressed()
    {
        //Set Text Quantity Item Button
        m_furtherButton.GetComponentInParent<ItemButton>().OnSetItemCountText(1);
    }

    private void OnRemoveButtonPressed()
    {
        //Set Text Quantity Item Button
        m_removeButton.GetComponentInParent<ItemButton>().OnSetItemCountText(1);
    }

    private void OnUnlockButtonPressed()
    {
        //Set Text Quantity Item Button
        m_unlockButton.GetComponentInParent<ItemButton>().OnSetItemCountText(1);
    }
